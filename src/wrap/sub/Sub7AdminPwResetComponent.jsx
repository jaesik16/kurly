...
export default function Sub7AdminPwResetComponent() {
    ...
    const onSubmitPwReset=(e)=>{
        ...
        axios({
            url:'http://answotlr12.dothome.co.kr/kurly/green_kurly_admin_pw_update.php',
            method:'Post',
            data:formData
        })
        .then((res)=>{
            console.log(res);
            if(res.data===1){
                confirmModalMethod('관리자님 비밀번호가 변경되었습니다.')
            }
            else{
    ...
    return (
        <main id='sub6' className='pw-reset-form' style={mainBg}>
            <section id="section1">
