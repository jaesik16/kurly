...
export default function Sub7AdminSignUpComponent() {
    ...
    const onClickIdBtn=(e)=>{
        ...
        if(regexp2.test(value)===false || regexp3.test(value)===true || regexp4.test(value)===true  ||  regexp5.test(value)===false ){
            ...
            axios({
                url:'http://answotlr12.dothome.co.kr/kurly/green_kurly_admin_id_duplicate_ok.php',
                method: 'POST',
                data: formData
            })
            .then((res)=>{
    ...
    const onClickEmailBtn=(e)=>{
        ...
        if(value===''){
            ...
            axios({
                url:'http://answotlr12.dothome.co.kr/kurly/green_kurly_admin_email_duplicate_ok.php',
                method: 'POST',
                data: formData
            })
            .then((res)=>{
    ...
    const onSubmitForm=(e)=>{
        ...
        if(state.아이디===''){
            ...
            // adminId      아이디          moonjong 
            // adminPw      비밀번호        moonjong123
            // adminName    이름            이순신
            // adminEmail   이메일          moonjong@naver.com
            // adminHp      휴대폰          01079425305
            // adminAddress 주소            신촌로
            // adminGender  성별            여성
            // adminBirth   생년월일        1970 10 9
            // adminAddInput 추가입력사항   친구초대 추천인 아이디 moonjong
            // adminService 이용약관동의    체크
            ...
            axios({
                url: 'http://answotlr12.dothome.co.kr/kurly/green_kurly_admin_signup.php',
                method: 'POST',
        ...
        <main id='sub5' className='sub7-signup'>
            <section id="signUp">
                <div className="container">
                    ...
                    <div className="title">
                        <h2 className="title-text1">MyAdmin</h2>
                        <h4 className="title-text2">관리자 회원가입</h4>
