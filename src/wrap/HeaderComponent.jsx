...
export default  function HeaderComponent(){
    ...
    const onClickLogOut=(e)=>{
        e.preventDefault();
        localStorage.removeItem('KURLY_SIGNIN_DATA');
                        ...
                        <div className="content">
                            <aside id="aside">
                                {   selector.signIn.로그인정보!==null &&
                                    <div className="signin-box" onMouseEnter={onMouseEnterSignIn} onMouseLeave={onMouseLeaveSignIn}>
                                        <Link to="/sub6" className="on">
                                            <span className="span1">{selector.signIn.로그인정보.회원등급==='admin'?'관리자':'일반'}</span>
                                            <span className="span2">{selector.signIn.로그인정보.이름} 님</span>
                                            <img className="img-new1" src="./images/header/header_new.svg" alt="" />
                                            <img className="img-new2" src="./images/header/header_icon.webp" alt="" />
                                        </Link>
                                        {   state.signInToolTip &&
                                            <div className="sign-tooltip">
                                                <ul>
                                                    ...
                                                    <li><Link to ="!#"><span>나의 컬리 스타일</span><img src="./images/header/header_new.svg" alt="" /></Link></li>
                                                    <li><Link to ="!#">컬리멤버스</Link></li>
                                                    {/* <li onClick={onClickLogOut}><Link to ="!#">로그아웃</Link></li> */}
